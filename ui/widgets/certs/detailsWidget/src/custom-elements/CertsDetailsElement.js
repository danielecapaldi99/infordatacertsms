...
class CertsDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'certs.details.';
    ...
    const ReactComponent = React.createElement(CertsDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('certs-details', CertsDetailsElement);
