...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/certs/tableWidget/>):
   1. Run `npm i`
...
- **certs.table.error** (fired when an error occurs)
- **certs.table.select** (fired when a table row is selected)
