    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="title">{t('entities.certs.title')}</option>
            <option value="content">{t('entities.certs.content')}</option>
            <option value="mainContent">{t('entities.certs.mainContent')}</option>
            <option value="attachments">{t('entities.certs.attachments')}</option>
            <option value="images">{t('entities.certs.images')}</option>
            <option value="date">{t('entities.certs.date')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
